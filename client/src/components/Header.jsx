...
const Header = () => {
    ...
    return (
        <>
            <section className="m-5 z-5 group fixed transition-all duration-500 w-fit max-w-full 
                    bg-gray-400 bg-opacity-40 backdrop-blur-lg left-1/2 hover:top-[90%] 
                      peer-focus:top-[85%] peer-focus-within:top-[85%] top-full transform -translate-y-5 -translate-x-1/2 
                ...
                <div className="absolute -top-6 left-1/2  w-32 bg-gray-400 bg-opacity-40 backdrop-blur-lg
                    ...
                    <i className="material-icons text-4xl text-white">keyboard_arrow_up</i>
                </div>
