...
const Dashboard = () => {
    const { user, friendRequests, friends, loading } = useContext(AuthContext);
    ...
    return (
        <>
            <div className="relative h-64 bg-gradient-to-r from-indigo-600 to-purple-600">
                <div className="absolute bottom-0 left-0 right-0 px-8 py-4 bg-black bg-opacity-40">
                    <div className="relative left-10 flex items-end space-x-6">
                        <img src={`/avatar/${user.id}`} alt="Profile Picture" 
                        ...
                        <div className="pb-4">
                            ...
                            <p className="text-gray-300 mt-3">Joined {new Date(user.created_at).toLocaleDateString()}</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div className="bg-slate-800 rounded-xl p-6 shadow-lg">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium">{ user.roomCount || 0 }</span>
                                </div>
                                <div className="flex justify-between">
            ...
            {/* </div> */}
            {showEditor && <Editor user={user} onClose={() => setShowEditor(false)} />}    
            <Header />
        </>
    );
};
